...
function PricingCard({active}:{active: string}) {
  return (
    <div className="w-full md:flex items-start justify-around py-8">
            ...
            </div>
            {
                freePlan.map((plan: PlanType, index: number) => (
                    <div key={index} className="flex w-full items-center py-4">
                        ...
                        <p className="pl-2 text-lg ">{plan.title}</p>
                    </div>
                ))
            }
            <br />
        ...
        <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
            ...
            <div className="pt-5">
                <p className="text-xl">Everthing in Launch, plus...</p>
            </div>
        ...
        <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
            ...
            <br />
            <div className="border-b border-[#000] pb-8">
                <h5 className="font-clashDisplay uppercase text-cyber-ink text-3xl">
            ...
            <div className="pt-5">
                <p className="text-xl">Everthing in Grow, plus...</p>
            </div>
