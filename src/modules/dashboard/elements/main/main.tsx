...
function Main() {
  ...
  return (
    <div className="p-5 w-full h-screen bg-[#f9fafb]">
        ...
        <p className="opacity-[0.7] text-sm pt-2">
        ...
        <div className="w-full flex">
          ...
          <div className="w-[35%] p-5">
            ...
            <div>
              ...
              <div className="w-full bg-white border border-gray-200 shadow-xs rounded p-5 my-3">
                {/* home page url */}
                <div>
                  <h4 className="font-medium">Home Page</h4>
                  <div className="w-full px-2 my-1 h-[38px] bg-transparent border-gray-200 border rounded-lg relative 
            ...
            {/* tutorials */}
            <div className="w-full bg-white border border-gray-200 shadow-sm rounded p-5 my-3">
              <h5 className="font-medium">Tutorials</h5>
              <p className="text-sm opacity-[0.7]">
                Learn how to get started on ShadyMedia and utilize all our features, directly from the Shady team.  
              </p>
              <br />
            ...
            <div className="w-full bg-white border border-gray-200 shadow-sm rounded p-5 my-3">
              ...
              <Link href={'/'}>
              <div className="w-max px-3 my-2 h-[33px] bg-transparent border border-gray-200 rounded-lg flex items-center">
