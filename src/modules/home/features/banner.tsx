    ...
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute">
          <h1 className="font-clashDisplay uppercase font-bold text-[2.75rem]
           md:text-[7xl] lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10"
           >
            THE NEWSLETTER PLATFORM BUILT FOR
            <span className="font-style text-pink-400 ml-2">
              GROWTH
             </span>
          </h1>
          <br />
          ...
          <div className="flex w-full justify-center">
            <Button color="primary" className="text-lg p-7">
              Get Started
            </Button>
          </div>
          <br />
